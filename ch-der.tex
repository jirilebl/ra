...
Two diagrams of a plot of a function f.  On the left,
...
$f(x)g(x)$ differs from the area of the unshaded rectangle $f(c)g(c)$
by the area of the two shaded rectangles 
$f(x)\bigl( g(x) - g(c) \bigr)$ and
$\bigl( f(x) - f(c) \bigr) g(c)$.
