...
(note that $t_0$ is a function of both $s$ and $t$)
such that
\begin{equation*}
...
\end{equation*}
Next there exists a number $s_0$ between $0$ and $s$ (again
$s_0$ is a function of $s$ and $t_0$, and hence a function
...
\frac{\partial^2 f}{\partial x_j \partial x_k}(p + s_0 e_j + t_0 e_k) .
\end{equation*}
Taking the limit as $(s,t) \in \R^2$ goes to zero we find that $(s_0,t_0)$
also goes to zero.  By continuity of the second partial derivatives we
find that
\begin{equation*}
