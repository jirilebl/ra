...
+ b a_k x_k .
\end{equation*}
Finally, if $Y$ is nonempty, $0 = 0 v$ for $v \in Y$ gives $0 \in Y$.
We have proved the following proposition.

\begin{prop}
Let $X$ be a vector space.  For every nonempty $Y \subset X$,
...
\end{equation*}
This implies that, assuming $\snorm{A}$ is not infinity, that for every $x$,
\begin{equation*}
