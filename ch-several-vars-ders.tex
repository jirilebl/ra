...
A graph in in the xyz-space of a function z equals f of x, y, which is a cone
...
An horizontal arrow to the right is labeled with e sub ell,
...
Above p plus s e sub ell and to the left of p plus t time e sub m
we have a point p plus s times e sub ell plus t times e sub m.
Above p plus s e sub ell and to the left of p plus t sub 0 time e sub m
