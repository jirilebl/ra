...
$\{ \tilde{x}_1,\tilde{x}_2,\ldots,\tilde{x}_\ell \}$.  Then clearly we can write
both linear combinations using vectors from the union
$\{ x_1,x_2,\ldots,x_k \} \cup
\{ \tilde{x}_1,\tilde{x}_2,\ldots,\tilde{x}_\ell \}$, by just taking zero
multiples of the vectors we do not need, e.g. $x_1 = x_1 + 0 \tilde{x}_1$.
...
is continuous.
\item
Show that there exists numbers $m$ and $M$ such
