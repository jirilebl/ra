...
the conclusion is true when $n=1$.  In this case, $f'(x)$
is the derivative of
\volIref{\chapterref*{vI-der:chapter} of volume I}{\chapterref{der:chapter}}
...
\end{equation*}
We have $\snorm{k+\theta_j e_n} \leq \snorm{h}
< \delta$, and so we can
finish the estimate
\begin{equation*}
\begin{split}
