...
not solvable for $y$ in terms of $x$ in every case.  For instance,
there is generally no solution
...
\end{align*}
The condition guaranteeing a solution is that $f=(f_1,f_2,\ldots,f_m)$ is a $C^1$ mapping
