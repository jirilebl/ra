...
Prove that a vector $x_1$ can be completed to a basis $\{ x_1,\ldots,x_n
\}$ such that $x_1 \cdot x_j = 0$ for $j \geq 2$.
For the right $x_1$,
...
the set
\begin{equation*}
U \coloneqq \bigl\{ (x,y) : 0.5 < x^2+y^2 < 2 \bigr\} \setminus \bigl\{ (x,0) : x <
0 \bigr\} .
\end{equation*}
For $(x,y) \in U$,
