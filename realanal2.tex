...
\usepackage{varioref}
% if using [original] then makeglossaries doesn't get run
% by glossaries automake unless \null is at the end and
% then we add an extra page. UGH!
\usepackage{imakeidx}
...
% Set up our index
% If we clear page, glossaries doesn't run makeglossaries (with automake)
...
% Adding \null here make automake glossaries work but adds a page,
% see \indexsetup{noclearpage} above
