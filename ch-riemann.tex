...
However it also follows
from $E(x)E(-x) = 1$.  Therefore we prove uniqueness of $E$ 
...
\end{equation*}
b)~Prove that $f$ is infinitely differentiable (it has derivatives of all
orders).\\
