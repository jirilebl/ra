...
Delta x sub 3 equals 1 minus epsilon, respectively.
...
proposition.  Note that $U(P,f)-L(P,f)$ is exactly the total area of the
unshaded part of the rectangles in \figureref{darbouxfig}.
