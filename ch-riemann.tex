...
The proof of the proposition above is \exerciseref{exercise:upperlowerlinineq}.
...
Uniqueness follow using properties \ref{it:log:i} and
...
more familiar to calculus students.  Really, there is only one logarithm:
...
$E'(x) = E(x)$, $E(0) = 1$.  Existence of course also follows
...
$p=2$, we already proved it converges, but we only roughly
estimated its sum.

Using the fundamental theorem of calculus we find that for $k \in \N$
we have
\begin{equation*}
