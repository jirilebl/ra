...
convergent, and it turns out that we would be correct because $\R$ has the
\hyperref[defn:lub]{least-upper-bound property}.  Before we prove this,
...
For any $N \geq K$, let $Q := \max \sigma\bigl(\{ 1,2,\ldots,N \}\bigr)$.
Compute
\begin{equation*}
\begin{split}
