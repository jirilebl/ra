...
\footnote{%
Sometimes it is called the Cauchy--Bunyakovsky--Schwarz inequality.
...
In case of an open subset of an open subset or a closed subset of a closed
subset, matters are even easier.
...
Notice that because $K$ is closed then $E$ is closed in $K$ if
