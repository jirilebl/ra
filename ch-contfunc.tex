...
much more horizontal at the right and point.
...
a first segment going accross half the graph starting at 
...
Two graphs.  On the left, an upward sloping diagonal linethat goes from
bottom left to the origin (not including the origin),
then jumps up and then continues diagonally up.
On the the right graph, the first line giving the
