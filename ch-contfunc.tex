...
exists a $y \in S$ such that $y \neq x$ and $\sabs{x - y} < \epsilon$.
Note that a cluster point of $S$ need not lie in $S$.

Let us see some examples.
\begin{enumerate}[(i)]
\item The set
$\{ \nicefrac{1}{n} : n \in \N \}$ has zero as its unique cluster point.
...
$x_n \neq x$ and $x_n \in S$ for all $n$, and $\lim\limits_{n\to\infty} x_n = x$.
\end{prop}
...
\begin{myfigureht}
\myincludegraphics{limvaldiff}{FIXMEALT}
...
\myincludepdft{sin1x_xsin1x}{FIXMEALT}
...
\end{defn}
\begin{myfigureht}
\myincludepdft{contigr}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{jumpdiscont}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{popcornfig}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{minmax}{FIXMEALT}
...
\end{enumerate}
\begin{myfigureht}
\myincludegraphics{bisect}{FIXMEALT}
...
\begin{myfigureht}
\myincludepdft{figimageinterval}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{lipschitzfig}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{sqrtgraph}{FIXMEALT}
...
of limit are you using.  If there is a possibility of confusion, one can
write, for example,
\begin{equation*}
...
\begin{myfigureht}
\myincludepdft{figinccont}{FIXMEALT}
...
\begin{myfigureht}
\myincludegraphics{increasing-discont-fig}{FIXMEALT}
...
\begin{myfigureht}
\myincludepdft{invcontfigAB}{FIXMEALT}
