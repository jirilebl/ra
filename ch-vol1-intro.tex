...
\end{equation*}
Let $D \subset B$.  Define the \emph{\myindex{inverse image}} of $D$ as
\glsadd{not:invimage}
\begin{equation*}
...
of pairs is $\bigl\{ (1,2), (1,3), (2,3) \bigr\}$.  So $1 < 2$ holds as $(1,2)$ is in
the set, but $3 < 1$ does not hold as $(3,1)$ is not in the set.

Similarly, the relation `$=$'
is defined by the pairs $\bigl\{ (1,1), (2,2), (3,3) \big\}$.
