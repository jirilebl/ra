...
%mbx <title>Basic Analysis I and II</title>
%mbx <subtitle>Introduction to Real Analysis, Volumes I and II</subtitle>
%mbx
%mbx <frontmatter>
%mbx   <titlepage>
%mbx
...
%mbx     </copyright>
%mbx     <p>
%mbx        Version 5.2 (volume I) and 2.2 (volume II)
%mbx     </p>
%mbx     <p>
...
\flushright
{\Huge\bfseries \sffamily Basic Analysis I and II}
\noindent\rule[-1ex]{\textwidth}{5pt}\\[2.5ex]
\hfill\emph{\Large \sffamily Introduction to Real Analysis, Volumes I and II}
\end{minipage}}
...
%FIXME: add mbx version of the Further reading

%mbx <references xml:id="furtherreading_chapter">
%mbx   <title>Further Reading</title>
%mbx
%mbx   <biblio type="raw" xml:id="biblio-BM" tag="BM">FIXME and FIXME
%mbx     <title><url href="https://books.google.com/books?id=FIXME"
%mbx     >FIXME</url></title>,
%mbx     FIXME</biblio>
%mbx
%mbx </references>
