...
Graphs of the functions x squared, x to the fourth, x to the sixth, and
x to the sixteenth.  The graphs are over the region from minus 1 to 1,
...
All the curves start at the same point on the
