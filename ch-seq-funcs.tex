...
We claim $\{ f_n \}_{n=1}^\infty$ converges uniformly to $f(x) := x$.  Let us compute:
\begin{equation*}
\begin{split}
\norm{f_n-f}_{[0,1]}
& =
...
\begin{exercise}
Let $f_n(x) := \frac{x^n}{n}$.  Show that $\{ f_n \}_{n=1}^\infty$ converges uniformly to
...
we have defined a sequence $\{ f_k \}_{k=1}^\infty$ of functions.  We need
