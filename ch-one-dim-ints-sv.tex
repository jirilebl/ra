...
continuous at $x$.  So given $\epsilon > 0$, $h$ can be small enough so that
...
\right) ~ dt .
\end{equation*}
We differentiate in $x_j$ under the integral, which can be done as
everything, including the partials themselves, is continuous.
\begin{equation*}
\begin{split}
