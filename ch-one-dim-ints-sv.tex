...
A diagram of a path in the plane.  The path has arrow indicating
...
raised above this curve and which has different height above different
points.}
...
to the point y, this direction is indicated as an arrow.
