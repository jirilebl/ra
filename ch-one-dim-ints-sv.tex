...
counterclockwise.  See \figureref{fig:squarepath}.  Let us check it is
...
has no ``corners'' where $\gamma$ is continuously differentiable.
...
$\beta := \gamma|_{[b,c]}$.
Let $\omega$ be a one-form defined on the image
of $\gamma$.  Then
\begin{equation*}
\int_{\gamma} \omega =
\int_{\alpha} \omega +
