...
undergraduate analysis course at University of Wisconsin---Madison in 2012, which
...
undergraduate analysis course at Oklahoma State University, modifying
...
and making many other smaller improvements.
...
book, or add sections to the end of existing chapters, and I will try as hard as
...
Several possibile routes after metric spaces,
...
(multivariable calculus, focus on multivariable integrals).
\item
%\volIref{Chapter \ref*{vI-ms:chapter} from volume I}{Chapter \ref{ms:chapter}},
