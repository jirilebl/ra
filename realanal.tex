...
\newglossaryentry{not:lim}{
  type=notation,
  name={$\lim$},
  description={limit},
}

\newglossaryentry{not:limsup}{
  type=notation,
  name={$\limsup$},
  description={limit superior},
}

\newglossaryentry{not:liminf}{
  type=notation,
  name={$\liminf$},
...
\newglossaryentry{not:series}{
  type=notation,
  name={\rule[-12pt]{0pt}{32pt}$\displaystyle \sum a_n$,  $\displaystyle \sum_{n=1}^\infty a_n$},
  description={series},
}

\newglossaryentry{not:riemannint}{
  type=notation,
  name={\rule[-12pt]{0pt}{32pt}$\displaystyle \int_a^b f$, $\displaystyle \int_a^b f(x)\, dx$},
...
\newglossaryentry{not:lowerdarboux}{
  type=notation,
  name={\rule[-14pt]{0pt}{36pt}$\displaystyle \underline{\int_a^b}f$},
  description={lower Darboux integral},
}

\newglossaryentry{not:upperdarboux}{
  type=notation,
  name={\rule[-14pt]{0pt}{36pt}$\displaystyle \overline{\int_a^b}f$},
